...
namespace Ecr.Module.Services.Ingenico.GmpIngenico
{
    ...
    public class ST_Z_REPORT
    {
        ...
        public string sDate;
        public string sTime;/**< uint64 999999999999 , Total Amount of Open Account transaction */
    ...
    {
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_CreateInterface", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_FP3_CreateInterface(ref UInt32 phInt, byte[] szID, byte IsDefault, byte[] szJsonXmlData);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetInterfaceXmlDataByID", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_FP3_GetInterfaceXmlDataByID(byte[] szID, byte[] szInterfaceXmlData, int JsonMaxLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetInterfaceXmlDataByHandle", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_FP3_GetInterfaceXmlDataByHandle(UInt32 hInt, byte[] szInterfaceXmlData, int JsonMaxLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_UpdateInterfaceXmlDataByID", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_FP3_UpdateInterfaceXmlDataByID(byte[] szID, byte[] szInterfaceXmlData);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_UpdateInterfaceXmlDataByHandle", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_FP3_UpdateInterfaceXmlDataByHandle(UInt32 hInt, byte[] szInterfaceXmlData);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetGlobalXmlData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_FP3_GetGlobalXmlData(byte[] szGlobalXmlData, int JsonMaxLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_UpdateGlobalXmlData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_FP3_UpdateGlobalXmlData(byte[] szGlobalXmlData);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetTaxRates", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetDepartments", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetTaxRates_Ex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetDepartments_Ex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetCurrencyProfile", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SetCurrencyProfile", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SetCurrencyProfileIndex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SetDepartments", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_KasaAvans", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_CustomerAvans", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_CariHesap", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_KasaPayment", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetTicket", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_ItemSale", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Payment", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionVasPaymentRefund", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_PrintUserMessage", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_PrintUserMessage_Ex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Plus", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_LoyaltyDiscount", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Minus", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Inc", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Dec", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_VoidAll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Pretotal", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Matrahsiz", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_VoidPayment", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_VoidItem", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionGetUniqueIdList", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionReadCard", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetCashierTable", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Echo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_FP3_Echo(UInt32 hInt, byte[] szEcho_Out, int EchoLen_Out, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetPaymentApplicationInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SetOnlineInvoice", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SetTaxFreeInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SetInvoice", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SendSMMData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SendGiderPusulasi", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SendEBilet", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SendEIrsaliyeInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SetTaxFree", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_StartPairingInit", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_FP3_StartPairingInit(UInt32 hInt, byte[] szPairing, byte[] szPairingResp, int PairingRespLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_ItemSale", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_Payment", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionReports", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionReadZReport", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionReadZReportP16", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionReadDM_Report", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionPaymentCheck", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_SetInvoice", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_SendSMMData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Json_prepare_SendSMMData(byte[] Buffer, int MaxSize, byte[] szJsonSMMData);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_SendEIrsaliyeInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Json_prepare_SendEIrsaliyeInfo(byte[] Buffer, int MaxSize, byte[] szJsonEIrsaliyeInfo);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_SendEBilet", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Json_prepare_SendEBilet(byte[] Buffer, int MaxSize, byte[] szJsonEBilet);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_SendGiderPusulasi", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Json_prepare_SendGiderPusulasi(byte[] Buffer, int MaxSize, byte[] szJsonSMMData);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_SetOnlineInvoice", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Json_prepare_SetOnlineInvoice(byte[] Buffer, int MaxSize, byte[] szJsonInvoiceInfo);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_SetTaxFreeInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_PrintUserMessage", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_PrintUserMessage_Ex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_parse_FiscalPrinter", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_parse_GetEcr", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_ReversePayment", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_Date", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_prepare_Condition", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_ReversePayment", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_JumpToECR", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_MultipleCommand", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SetParkingTicket", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_SetTaxFreeRefundAmount", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_LoyaltyCustomerQuery", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionChangeTicketHeader", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetTicketHeader", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetOnlineInvoiceInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Database_QueryColomnCaptions", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Database_QueryReadLine", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Database_FreeStructure", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Database_Execute", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetPLU", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetVasApplicationInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetVasPaymentServiceInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_GetVasLoyaltyServiceInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionEkuSeek", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FileSystem_DirListFiles", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionEkuReadHeader", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionEkuReadData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionEkuReadInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionModuleReadInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionBankingRefund", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionBankingRefundExt", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionBankingBatch", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_SetIniParameters", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_SetIniParameters(string szJsonIniParameter);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_GetIniParameters", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Json_GetIniParameters(byte[] szJsonIniParameter_Out, int szJsonIniParameterLen_Out);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionGetHandleList", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_FunctionTransactionInquiry", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Get24HResetTime", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Json_FP3_Set24HResetTime", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        public static UInt32 FP3_ItemSale(UInt32 hInt, UInt64 hTrx, ref ST_ITEM StItem, ref ST_TICKET pstTicket, int TimeoutInMiliseconds)
        {
            ...
            if (retcode == 0)
            {
                ...
                Console.WriteLine(retJsonString);
                ST_TICKET StTicketTemp = new ST_TICKET();
                StTicketTemp = JsonConvert.DeserializeObject<ST_TICKET>(retJsonString);
                MergeItemStruct(pstTicket, StTicketTemp);
            }
    ...
    class GMPSmartDLL
    {//C:\Users\ibrahimbozkurt\Desktop\Air Ecr\Ecr.Host\bin\Debug\Modules\ingenico\GMPSmartDLL.dll
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "GenerateUniqueID", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 GenerateUniqueID(byte[] szPath);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_RemoveInterfaceByID", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_RemoveInterfaceByID(string InterfaceId);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "SetXmlFilePath", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 SetXmlFilePath(string szPath);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "GetXmlFilePath", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 GetXmlFilePath(byte[] szPath);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionCreateUniqueId", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FunctionCreateUniqueId(UInt32 hInt, byte[] UniqueId, int timeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetInterfaceHandleList", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_GetInterfaceHandleList(UInt32[] phInt, UInt32 Max);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetInterfaceID", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_GetInterfaceID(UInt32 hInt, byte[] szID, UInt32 Max);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetInterfaceHandleByID", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_GetInterfaceHandleByID(ref UInt32 phInt, byte[] szID);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_RemoveInterfaceByHandle", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_RemoveInterfaceByHandle(UInt32 phInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionCashierLogin", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionAddCashier", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "SetIniFilePath", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern void SetIniFilePath_WE(byte[] szPath); // Without Encoding

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_Database_Open", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_Database_Open_WE(UInt32 hInt, byte[] szName); // Without Encoding

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FileSystem_DirChange", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FileSystem_DirChange_WE(UInt32 hInt, byte[] szDirName); // Without Encoding

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FileSystem_FileRead", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_SetPluDatabaseInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_SetPluDatabaseInfo_WE(UInt32 hInt, byte[] szPluDbName, short szPluDbType); // Without Encoding

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Database_Query", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Database_Query_WE(byte[] szSqlWord, ref ushort pNumberOfColomns);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_Database_Query", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_Database_Query_WE(UInt32 hInt, byte[] szSqlWord, ref ushort pNumberOfColomns);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_SetTaxFree", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_KasaAvans", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_KasaAvans(byte[] Buffer, int MaxSize, int Amount, byte[] pCustomerName, byte[] pTckn, byte[] pVkn);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "GetTagName", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern byte[] GetTagName(UInt32 Tag);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "GetErrorMessage", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern void GetErrorMessage(UInt32 ErrorCode, byte[] Buffer);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_DisplayPaymentSummary", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int FP3_DisplayPaymentSummary(UInt32 hInt, UInt64 hTrx, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionCashierLogout", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int FP3_FunctionCashierLogout(UInt32 hInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FiscalPrinter_GetHandle", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern ulong FiscalPrinter_GetHandle();

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FiscalPrinter_ResetHandle", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern void FiscalPrinter_ResetHandle();

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_TicketHeader", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_TicketHeader(UInt32 hInt, UInt64 hTrx, TTicketType TicketType, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_PrintTotalsAndPayments", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_PrintTotalsAndPayments(UInt32 hInt, UInt64 hTrx, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_PrintBeforeMF", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_PrintBeforeMF(UInt32 hInt, UInt64 hTrx, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_PrintMF", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_PrintMF(UInt32 hInt, UInt64 hTrx, int TimeoutInMiliseconds);  //TIMEOUT_PRINT_MF

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_Ping", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_Ping(UInt32 hInt, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_StartEx", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetCurrentHandle", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_Close", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_Close(UInt32 hInt, UInt64 hTrx, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionEcrParameter", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FunctionEcrParameter(UInt32 hInt, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionBankingParameter", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FunctionBankingParameter(UInt32 hInt, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionOpenDrawer", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FunctionOpenDrawer(UInt32 hInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionNTP_Check", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FunctionNTP_Check(UInt32 hInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionPaperEject", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FunctionPaperEject(UInt32 hInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetCurrentFiscalCounters", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_GetCurrentFiscalCounters(UInt32 hInt, ref ushort pZNo, ref ushort pFNo, ref ushort pEKUNo);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "Database_GetHandle", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 Database_GetHandle();

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_Database_GetHandle", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_Database_GetHandle(UInt32 hInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_Database_Close", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_Database_Close(UInt32 hInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_Database_QueryReset", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_Database_QueryReset(UInt32 hInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_Database_QueryFinish", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_Database_QueryFinish(UInt32 hInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionEkuPing", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FunctionEkuPing(UInt32 hInt, int TimeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetTlvData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_GetTlvData(UInt32 hInt, int Tag, byte[] pData, short MaxBufferLen, ref short pDataLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FileSystem_FileRemove", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FileSystem_FileRemove(UInt32 hInt, byte[] pFileName);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FileSystem_FileRename", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FileSystem_FileRename(UInt32 hInt, byte[] pFileNameOld, byte[] pFileNameNew);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FileSystem_FileWrite", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "GMP_GetDllVersionEx", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 GMP_GetDllVersionEx(byte[] pVersion, uint Max);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetPluDatabaseInfo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpReadTLVlen_HL", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt16 gmpReadTLVlen_HL(ref ushort pLen, byte[] pPtr, ushort PtrLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpReadTLVtag_HL", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt16 gmpReadTLVtag(ref uint pTag, byte[] pPtr, ushort PtrLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpTlvSetLenEx", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt16 gmpTlvSetLenEx(byte[] pMsg, ushort Max, ushort TlvLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpSetTLV_HLEx", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt16 gmpSetTLV_HLEx(byte[] pMsg, int pMsgLen, int Max, uint Tag, byte[] pdata, ushort dataLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpSetTLVbcdEx", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt16 gmpSetTLVbcdEx(byte[] pMsg, ushort Max, uint Tag, uint Data, ushort BcdLen);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpSearchTLV", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpSearchTLVbcd_8", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpSearchTLVbcd_16", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpSearchTLVbcd_32", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "gmpSearchTLVbcd_64", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Start", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_TicketHeader", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_TicketHeader(byte[] Buffer, int MaxSize, TTicketType TicketType);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Close", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_Close(byte[] Buffer, int MaxSize);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_OptionFlags", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_OptionFlags(byte[] Buffer, int MaxSize, ulong FlagsToBeSet, ulong FlagsToBeClear);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_PrintBeforeMF", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_PrintBeforeMF(byte[] Buffer, int MaxSize);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_PrintMF", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_PrintMF(byte[] Buffer, int MaxSize);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_SetParkingTicket", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_SetParkingTicket(byte[] Buffer, int MaxSize, byte[] pCarIdentification);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_PrintTotalsAndPayments", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_PrintTotalsAndPayments(byte[] Buffer, int MaxSize);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_VoidItem", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_VoidItem(byte[] Buffer, int MaxSize, ushort Index, long ItemCount, byte ItemCountPrecision);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Matrahsiz", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_Matrahsiz(byte[] Buffer, int MaxSize, byte[] pTckNo, long MatrahsizAmount);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Pretotal", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_Pretotal(byte[] Buffer, int MaxSize);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_DisplayPaymentSummary", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_DisplayPaymentSummary(byte[] Buffer, int MaxSize);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Plus", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_Plus(byte[] Buffer, int MaxSize, int Amount, UInt16 IndexOfItem);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Plus_Ex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_Plus_Ex(byte[] Buffer, int MaxSize, int Amount, byte[] szText, UInt16 IndexOfItem);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Minus", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_Minus(byte[] Buffer, int MaxSize, int Amount, ushort IndexOfItem);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Minus_Ex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_Minus_Ex(byte[] Buffer, int MaxSize, int Amount, byte[] szText, ushort IndexOfItem);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Inc", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_Inc(byte[] Buffer, int MaxSize, byte Rate, ushort IndexOfItem);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Dec", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_Dec(byte[] Buffer, int MaxSize, byte Rate, ushort IndexOfItem);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_VoidPayment", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_VoidPayment(byte[] Buffer, int MaxSize, ushort Index);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_VoidAll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_VoidAll(byte[] Buffer, int MaxSize);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_JumpToECR", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern int prepare_JumpToECR(byte[] Buffer, int MaxSize, ulong JumpFlags);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_SetTaxFreeRefundAmount", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Text", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Amount", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_Password", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_MsgBox", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_SetuApplicationFunction", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetDialogInput_Text", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetDialogInput_Date", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetDialogInput_Amount", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetDialogInput_MsgBox", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetDialogInput_Password", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_OptionFlags", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_SetTlvData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_SetTlvData(UInt32 hInt, UInt32 Tag, byte[] pData, UInt16 Len);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_SendFrontStationPrint", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_SendFrontStationPrintEx", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FiscalPrinter_SendFrontStationPrint", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_IsGmpPairingDone", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_IsGmpPairingDone(UInt32 hInt);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_FunctionLoadBackGroundHandleToFront", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_FunctionLoadBackGroundHandleToFront(UInt32 hInt, UInt64 hTrx, int timeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetMerchantSlip", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_GetUserData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_SendUserData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_SendUserData(UInt32 hInt, UInt64 hTrx, byte[] userData, int dataLen, int timeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "FP3_SetDrawerState", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 FP3_SetDrawerState(UInt32 hInt, int state, int timeoutInMiliseconds);

        [DllImport(@"Modules\ingenico\GMPSmartDLL.dll", EntryPoint = "prepare_SendUserData", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    ...
    class Defines
    {
        ...
        public const int TIMEOUT_ECHO = 3000;	// 3 seconds
        ...
        public const int APP_OTP2_SUPPORT_GET_MERCHANT_SLIP = 0x00000200;
        ...
        public const int APP_ERR_NOT_ALLOWED_AS_GMP3_TRANSACTION_IS_PENDING = 0x0831;
        ...
        public const int APP_ERR_FISCAL_KDV_RATE_NOT_FOUND = 2010; //2010
        ...
        public const int APP_ERR_FISCAL_SOFTWARE_VERSION /*2030*/                                                                  = 2030;
        ...
        public const int APP_ERR_APL_DB_ERROR /* 2040*/                                                                            = 2040;
        ...
        public const int APP_ERR_INACTIVE_PERIPHERAL /*2050*/                                                                      = 2050;
        ...
        public const int APP_ERR_GIB_ROOT_CERT_NOT_FOUND = 2118;
        public const int APP_ERR_GIB_SUB_ROOT_CERT_NOT_FOUND = 2119;
        public const int APP_ERR_TSM_ROOT_CERT_NOT_FOUND = 2120;
        public const int APP_ERR_TSM_SUB_ROOT_CERT_NOT_FOUND = 2121;
        public const int APP_ERR_OKTEM_CERT_NOT_FOUND = 2122;
        public const int APP_ERR_GIB_SIGN_CERT_NOT_FOUND = 2123;
        public const int APP_ERR_GIB_SIFRE_CERT_NOT_FOUND = 2124;
        public const int APP_ERR_TSM_SIGN_CERT_NOT_FOUND = 2125;
        public const int APP_ERR_PACK_GIB = 2126;
        public const int APP_ERR_GIB_CERT = 2127;
        public const int APP_ERR_DATABASE_SILINMIS = 2128;
        ...
        public const int APP_ERR_GMP3_UNDEFINED_CIHAZ_MODEL = 2304;	            //2304,
        public const int APP_ERR_GMP3_UNDEFINED_CIHAZ_VENDOR = 2305;
        public const int APP_ERR_GMP3_UNDEFINED_CIHAZ_SERINO = 2306;
        public const int APP_ERR_GMP3_UNDEFINED_MSG_TYPE = 2307;                  // 2307
        ...
        public const int APP_ERR_GMP3_VERIFY = 2316;                              // 2316
        ...
        public const int APP_ERR_GMP3_UNKNOWN_DEVICE = 2330;                      //2330
        public const int APP_ERR_GMP3_VERSION_MISMATCH = 2331;                    //2331
        public const int APP_ERR_GMP3_NO_PRIME_NUMBER = 2332;                     //2332
        public const int APP_ERR_GMP3_PERMISSION = 2333;                          //2333
        public const int APP_ERR_GMP3_INCORRECT_DEVICE = 2334;                    //2334
        ...
        public const int APP_ERR_GMP3_APP_CHECKSUM_MISMATCH = 2338;               // 2338
        public const int APP_ERR_GMP3_APP_DATE_EXPIRED = 2339;                    // 2339
        public const int APP_ERR_GMP3_TCP_RECEIVE_ERROR = 2340;
        public const int APP_ERR_GMP3_NO_HANDLE = 2341;                           // Handle NULL veya hiç bulunamadı

        public const int APP_ERR_GMP3_PAYMENT_KDV_NOT_AVAILABLE = 2400;
        public const int APP_ERR_GMP3_ITEM_NOT_AVAILABLE = 2401;                  // 01
        public const int APP_ERR_GMP3_OKC_KISIM_UNKNOWN = 2402;                   // 02
        public const int APP_ERR_GMP3_DOVIZ_UNKNOWN = 2403;                	    // 03 // not used
        public const int APP_ERR_GMP3_KASIYER_UNKNOWN = 2404;                     // 04 // not used
        public const int APP_ERR_GMP3_FUNC_OKC_PARAMETRE = 2405;                  // 05
        public const int APP_ERR_GMP3_FATURA_ODEME_PARAMETRE = 2406;              // 06 // not used
        public const int APP_ERR_GMP3_Z_RAPOR = 2407;                             // 07
        public const int APP_ERR_GMP3_X_RAPOR = 2408;                             // 08
        public const int APP_ERR_GMP3_BATTERY_LEVEL = 2409;                	    // 09
        public const int APP_ERR_GMP3_EKU_RAPOR_TYPE = 2410;                      // 10
        public const int APP_ERR_GMP3_EKU_STATE = 2411;                	        // 11
        public const int APP_ERR_GMP3_ECR_NOT_FISCAL = 2412;                      // 12 // tekrar edilmiş
        public const int APP_ERR_GMP3_NO_FUNCTION = 2413;                         // 13
        public const int APP_ERR_GMP3_MALI_KUMULATIF_RAPOR = 2414;                // 14
        public const int APP_ERR_GMP3_SINEMA_BILET_DESTEGI = 2415;                // 15 // not used
        public const int APP_ERR_GMP3_PARAMETRE_HATASI = 2416;                    // 16
        public const int APP_ERR_GMP3_Z_REQUIRED = 2417;                          // 17
        public const int APP_ERR_GMP3_UNSUPPORTED = 2418;                         // 18
        public const int APP_ERR_GMP3_SINEMA_URUN_SAYISI = 2419;                  // 19 // not used
        public const int APP_ERR_GMP3_PAYMENT_CANCELLED = 2420;                   // 20
        public const int APP_ERR_GMP3_ITEM_URUN_SAYISI = 2421;                    // 21
        public const int APP_ERR_GMP3_RESOURCE_PROBLEM = 2422;                    // 22
        public const int APP_ERR_GMP3_PLU_NOT_FOUND = 2423;                       // 23
        public const int APP_ERR_GMP3_NOT_PROPER_DISCOUNT = 2424;                 // 24
        public const int APP_ERR_GMP3_BIRIM_NOT_FOUND = 2425;                     // 25
        public const int APP_ERR_GMP3_MIKTAR_NOT_FOUND = 2426;                    // 26
        public const int APP_ERR_GMP3_URUN_ADI_NOT_FOUND = 2427;                  // 27
        public const int APP_ERR_GMP3_TUTAR_NOT_FOUND = 2428;                     // 28
        public const int APP_ERR_GMP3_UNKNOWN_ISLEM_TIPI = 2429;                  // 29
        public const int APP_ERR_GMP3_VERGI_NOT_AVAILABLE = 2430;                 // 30 // not used
        public const int APP_ERR_GMP3_ISLEM_NOT_ALLOWED = 2431;                   // 31
        public const int APP_ERR_GMP3_CURRENCY_NOT_AVAILABLE = 2432;              // 32
        public const int APP_ERR_GMP3_FIS_ITEM_NOT_ALLOWED = 2433;                // 33 // not used
        public const int APP_ERR_GMP3_FATURA_PARAMETER_MISSING = 2434;            // 34 // not used
        public const int APP_ERR_GMP3_FATURA_TARIHI_MISSING = 2435;               // 35 // not used
        public const int APP_ERR_GMP3_TUTAR_NOT_REQUIRED = 2436;                  // 36 // not used
        public const int APP_ERR_GMP3_TUTAR_REQUIRED = 2437;                      // 37 //tekrar edilmiş
        public const int APP_ERR_GMP3_INCORRECT_PASSWORD = 2438;                  // 38 
        public const int APP_ERR_GMP3_INACTIVE_CASHIER_INDEX = 2439;              //39
        public const int APP_ERR_GMP3_APPLICATION_NOT_FOUND = 2440;               // 40 // not used
        public const int APP_ERR_GMP3_UNDEFINED_TAG = 2441;                       // 41
        public const int APP_ERR_GMP3_SAVE_ECR_HEADER = 2442;                     //	42 // not used
        public const int APP_ERR_GMP3_INVALID_RECIPT_LIMIT = 2443;                //	43 // not used
        public const int APP_ERR_GMP3_ADVANCE = 2444;                             //	44
        public const int APP_ERR_GMP3_PAYMENT = 2445;                             //	45
        public const int APP_ERR_GMP3_TRANSACTION_IS_ACTIVE = 2446;               //	46
        public const int APP_ERR_GMP3_FATURA_TYPE_NOT_AVAILABLE = 2447;           // 47
        public const int APP_ERR_GMP3_FATURA_INVALID_TCK = 2448;                  // 48
        public const int APP_ERR_INVALID_UNIQUE_ID = 2449;                        // 49
        public const int APP_ERR_GMP3_TICKET_TYPE = 2450;                         // 50
        public const int APP_ERR_GMP3_SETTINGS = 2451;                            // 51
        public const int APP_ERR_GMP3_BITMAP = 2452;                              // 52
        public const int APP_ERR_GMP3_FILE = 2453;                                // 53
        public const int APP_ERR_GMP3_ADMIN_PASSWORD_BLOCKED = 2454;              // 54
        public const int APP_ERR_GMP3_CASHIER_PASSWORD_BLOCKED = 2455;            // 55
        public const int APP_ERR_GMP3_CASHIER_PASSWORD_INCORRECT = 2456;          // 56
        public const int APP_ERR_GMP3_VAS_SUPPORT = 2457;                         // 57
        public const int APP_ERR_GMP3_OTOPARK_PARAMETER = 2458;                   // 58
        ...
        public const int DLL_RETCODE_No_ERR = 0xF008;
        ...
        public const int GMP3_RECEIPT_CAN_NOT_VOID = 0x0932;
        public const int ING_PRN_RET_PORT_DATA_NOT_RECEIVED = 57349;
        public const int ING_PRN_RET_EXTERNAL_PRINTER_TO = 57381;
        ...
        public const int PARTIAL_PAYMENT_FLAG_MERCHANT = 0x01;
        public const int PARTIAL_PAYMENT_FLAG_CUSTOMER = 0x02;
        public const int PARTIAL_PAYMENT_FLAG_CANCEL = 0x04;
        public const int PARTIAL_PAYMENT_FLAG_CANCEL_SENT = 0x08;
        public const int PARTIAL_PAYMENT_FLAG_TERMINAL_SAVED = 0x10;
    }

    public class ST_SMMData
    {
        ...
        public int StopajOrani { get; set; }
        public int TevkifatOrani { get; set; }
    }
    ...
    public class ST_Gider_Pusulasi
    {
        ...
        public string FaturaSira { get; set; }
        public string FaturaTarih { get; set; }
        public UInt16 StopajOrani { get; set; }
